...
async function POST(request) {
    try {
        ...
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$user$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyUser"])(email, password);
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$usage$2d$log$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createUsageLog"])(user.id, "LOGIN", `User logged in: ${email}`, ip);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            user,
            token
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8c77d407._.js.map