...
"[project]/app/api/admin/transactions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        const transactionsWithUsers = await Promise.all(transactions.map(async (transaction)=>{
            const user = await db.collection("users").findOne({
                _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](transaction.userId)
            });
            return {
                ...transaction,
...
async function PUT(request) {
    ...
    try {
        ...
        if (action === "approve") {
            ...
            // Add credits to user
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$user$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addCreditsToUser"])(transaction.userId, transaction.creditsAmount);
            // If this is a plan upgrade, update the user's plan
            if (transaction.planUpgrade) {
                const { updateUserPlan } = await __turbopack_context__.A("[project]/lib/models/user.ts [app-route] (ecmascript, async loader)");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__65da90f8._.js.map